...
class ap_DevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:\\xampp\\htdocs\\Agencia_Viajes\\app\\cache\\de_/annotations', true);
    }
    ...
    {
        return $this->services['assetic.controller'] = new \Symfony\Bundle\AsseticBundle\Controller\AsseticController($this->get('assetic.asset_manager'), new \Assetic\Cache\FilesystemCache('C:\\xampp\\htdocs\\Agencia_Viajes\\app\\cache\\de_/assetic/assets'), false, $this->get('profiler', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setProxyDir('C:\\xampp\\htdocs\\Agencia_Viajes\\app\\cache\\de_/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_dee3f10154203bff885c1a8768dc02adbbc4c4a7c84149144209cc19b01a1cb5');
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:\\xampp\\htdocs\\Agencia_Viajes\\app\\cache\\de_/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:\\xampp\\htdocs\\Agencia_Viajes\\app\\cache\\de_/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:\\xampp\\htdocs\\Agencia_Viajes\\app\\cache\\de_/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:\\xampp\\htdocs\\Agencia_Viajes\\app\\cache\\de_');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => 'C:\\xampp\\htdocs\\Agencia_Viajes\\app\\cache\\de_',
            ...
            'session.save_path' => 'C:\\xampp\\htdocs\\Agencia_Viajes\\app\\cache\\de_/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:\\xampp\\htdocs\\Agencia_Viajes\\app\\cache\\de_/profiler',
            ...
            'router.resource' => 'C:\\xampp\\htdocs\\Agencia_Viajes\\app\\cache\\de_/assetic/routing.yml',
            ...
            'debug.container.dump' => 'C:\\xampp\\htdocs\\Agencia_Viajes\\app\\cache\\de_/ap_DevDebugProjectContainer.xml',
            ...
            'swiftmailer.spool.default.memory.path' => 'C:\\xampp\\htdocs\\Agencia_Viajes\\app\\cache\\de_/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:\\xampp\\htdocs\\Agencia_Viajes\\app\\cache\\de_/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'C:\\xampp\\htdocs\\Agencia_Viajes\\app\\cache\\de_/doctrine/orm/Proxies',
