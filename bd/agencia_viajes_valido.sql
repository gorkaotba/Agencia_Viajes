...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-11-2016 a las 22:38:00
...
INSERT INTO `categoria` (`ID_cat`, `Nombre_cat`, `Descripcion_cat`) VALUES
...
--
-- Volcado de datos para la tabla `cat_ofe`
--

INSERT INTO `cat_ofe` (`ID_oferta`, `ID_categoria`, `Nombre_cat_ofe`, `Descripcion_cat_ofe`) VALUES
(1, 5, 'Salida cultural', 'Conoce la capital europea. '),
(2, 2, 'Para aventurero/as', 'No dejes escapar esta oportunidad para disfrutar de la nieve.'),
(3, 1, 'Déjate llevar', 'Ha llegado el momento de cumplir ese sueño que siempre has tenido, conocer el Caribe.'),
(4, 3, 'Encanto del nórdico', 'En tan solo 7 días conoce todos los sitios más impresionantes de los países nórdicos.');
...
--
ALTER TABLE `destinos`
  MODIFY `ID_dest` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
